...
model_full <- glmer(
  correct_source ~ ecology_contrast * valence_contrast * lzo_centered +
...
three_way_row <- grep("ecology_contrast:valence_contrast:lzo_centered", rownames(anova_table), value = TRUE)
...
model_gender <- glmer(
  correct_source ~ ecology_contrast * valence_contrast * gender +
         (1 | vp_id) +
         (1 | face_id),
  data = data_trial_hits,
  family = binomial(link = "logit"),
